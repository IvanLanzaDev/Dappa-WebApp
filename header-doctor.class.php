...
<html lang="pt-br">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dappa">
        <a class="navbar-brand text-white mx-auto pr-5 dappa-logo-font" href="dashboard-doctor.php">Dappa</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-link" href="#"><i class="fas fa-home fa-sm"></i>&nbsp; Início </a>
                </li>
                <!--<li class="nav-item">
                    <a class="nav-link" href="#"><i class="fas fa-calendar-alt fa-sm"></i>&nbsp; Agenda </a>
                </li>-->
                <!--<li class="nav-item">
                    <a class="nav-link" href="#"><i class="fas fa-clinic-medical fa-sm"></i>&nbsp; Meu Consultório</a>
                </li>-->
                <!--<li class="nav-item">
