    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dappa">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-link" href="dashboard-clinic.php"><i class="fas fa-home fa-sm"></i>&nbsp; Início </a>
                </li>
               
                <li class="nav-item">
                    <a class="nav-link" href="my-clinic.php"><i class="fas fa-clinic-medical fa-sm"></i>&nbsp; Meu Consultório</a>
                </li>
                <li class="nav-item">
