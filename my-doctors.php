...
<hr>
        <form method="POST" action="">
            <div class="form-group">
                <input type="text" class="form-control" placeholder="Nome do especialista" name="name_doctors">
            </div>
            <div class="form-group">
            ...
            <button type="submit" class="btn btn-success btn-block" name="btn_new_doctor">Cadastrar</button>
        </form>
