...
<html lang="pt-br">
  ...
  <div class="container">
    <div class="card mt-4 mb-5">
        ...
        <h2 class="text-info mt-5"> Parabéns </h2>
        <p class="lead text-secondary">Seu consulório foi cadastrado. <br>Agora seus pacientes podem fazer agendamentos.</p>

        <div class="row mb-4">
           <div class="container mt-5">
            <a href="dashboard-clinic.php" class="btn btn-info">Início</a>
           </div>
        </div>
